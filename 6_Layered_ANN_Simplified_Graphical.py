...
def hidden_Layers_Calculations(inputs):
    ...
    return hidden_weights,hidden_biases,hidden_outputs,output_weights,output_bias,final_output
####################################################################################################
...
def main():
    ...
    print(BORDER)
    hidden_weights,hidden_biases,hidden_outputs,output_weights,output_bias,final_output=hidden_Layers_Calculations(inputs)
    displayGraphics(inputs,hidden_weights,hidden_biases,hidden_outputs,output_weights,output_bias,final_output)
#####################################################################################################
#   Function Name   :   displayGraphics
#   Input Params    :   inputs,hidden_weights,hidden_biases,hidden_outputs,output_weights,output_bias,final_output
#   Output Params   :   None
#   Description     :   Main entry point of the program
#   Author          :   Vaishali M. Jorwekar             
#####################################################################################################    
def displayGraphics(inputs,hidden_weights,hidden_biases,hidden_outputs,output_weights,output_bias,final_output):
    # Plot nodes
    ...
    # Label nodes
    plt.text(0.95, 2, f"x1\n{inputs[0]}", ha='center', va='center', fontsize=10)
    plt.text(0.95, 1, f"x2\n{inputs[1]}", ha='center', va='center', fontsize=10)  
    
    plt.text(3, 2.5, f"h1\n{np.round(hidden_outputs[0], 3)}", ha='center', va='center', fontsize=10)
    plt.text(3, 0.5, f"h2\n{np.round(hidden_outputs[1], 3)}", ha='center', va='center', fontsize=10)
  
    plt.text(5, 1.5, f"y\n{final_output:.3f}", ha='center', va='center', fontsize=10)

    #label Biases
    plt.text(3, 2.8, f"b1\n{np.round(hidden_biases[0], 3)}", ha='center', va='center', fontsize=10)
    plt.text(3, 0.7, f"b2\n{np.round(hidden_biases[1], 3)}", ha='center', va='center', fontsize=10)
    plt.text(5, 1.7, f"b2\n{np.round(output_bias[0], 3)}", ha='center', va='center', fontsize=10)

    # Layer labels
    plt.text(1, 2.6, "Input Layer", ha='center', fontsize=12)
    plt.text(3, 2.6, "Hidden Layer", ha='center', fontsize=12)
    plt.text(5, 2.6, "Output Layer", ha='center', fontsize=12)
    
    # Weight labels
    plt.text(1.8, 2.3, f"w11={np.round(hidden_weights[0][0],2)}", fontsize=9)
    plt.text(1.8, 1.3, f"w12={np.round(hidden_weights[1][0],2)}", fontsize=9)
    plt.text(1.8, 1.8, f"w21={np.round(hidden_weights[0][1],2)}", fontsize=9)
    plt.text(1.8, 0.8, f"w22={np.round(hidden_weights[1][1],2)}", fontsize=9)

    plt.text(4, 2.2, f"w_out1={np.round(output_weights[0][0],2)}", fontsize=9)
    plt.text(4, 1.0, f"w_out2={np.round(output_weights[0][1],2)}", fontsize=9)
